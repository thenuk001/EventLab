        ...
        <div class="mx-auto max-w-7xl px-4">
            ...
            <div class="mb-8 rounded-3xl bg-gradient-to-r from-slate-900 via-purple-900 to-orange-600 p-8 text-white shadow-xl">
                ...
                <p class="mt-3 text-slate-200">
                    Approve, reject, comment, and feature company-submitted events before they appear publicly.
                </p>
            </div>
                    ...
                    <div class="rounded-3xl bg-white p-6 shadow">
                        <div class="grid gap-6 lg:grid-cols-12">
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <p class="mt-1 font-bold">{{ $event->company?->name ?? 'No company' }}</p>
                            </div>

                            <div class="lg:col-span-2">
                                <p class="text-sm font-bold text-gray-500">Category</p>
                                <p class="mt-1 font-bold">{{ $event->category?->name ?? 'No category' }}</p>
                            </div>
